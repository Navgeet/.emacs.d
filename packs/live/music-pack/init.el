...
(live-load-config-file "emms-conf.el")
(live-load-config-file "emms-browser-conf.el")
(live-load-config-file "emms-cache-conf.el")
...
(live-load-config-file "emms-volume-conf.el")
